  ...
  return (
    <div id="about" className="w-full p-4 py-16 items-center">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        ...
        <div className="w-full h-auto m-auto shadow-xl hover:shadow-gray-400 rounded-xl flex items-center justify-center p-2 hover:scale-105 ease-in duration-300">
          <Image
