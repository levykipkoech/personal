    ...
    return (
        <div className={shadow ? "fixed w-full h-20 shadow-xl z-[100]" : "fixed w-full h-20 z-[100]"}>
            ...
            <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
              <div className={nav ? "fixed left-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] ease-in duration-500"
              : "fixed left-[-100%] top-0 p-10 ease-in duration-500"}>
                ...
                <div className="p-4 flex flex-col">
                    <ul className="uppercase">
                        <Link href='/#main'>
                            <li onClick={()=> setNav(false)} className="p-4 text-sm">Home</li>
                        </Link>
                        <Link href="/#about">
                            <li onClick={()=> setNav(false)} className="p-4 text-sm">About</li>
                        </Link>
                        <Link href="/#projects">
                            <li onClick={()=> setNav(false)} className="p-4 text-sm">Projects</li>
                        </Link>
                        <Link href="/#skills">
                            <li onClick={()=> setNav(false)} className="p-4 text-sm">Skills</li>
                        </Link>
                        <Link href="/#contact">
                            <li onClick={()=> setNav(false)} className="p-4 text-sm">Contact</li>
                        </Link>
                    </ul>
                    <div className="pt-40">
