      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <p className="py-4 text-gray-600 max-w-[70%] m-auto">
            I am recent software developer graduate with passion for software
            development. I am seeking a software developer position that will
            allow me to apply my skills and knowledge to contribute to the
            development of cutting edge software solutions. I am a quick
            learner, detail-oriented, and committed to delivering high-quality
            code.
          </p>
