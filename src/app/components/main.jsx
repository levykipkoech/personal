    ...
    <div className="text-center pt-20 items-center">
      ...
      <div className="flex items-center justify-between max-w-[330px] m-auto py-4">
        <a
          ...
          rel="noreferrer"
        >
          <div className=" intersect:motion-preset-shrink intersect:motion-delay-100 intersect:motion-duration-100 rounded-full shadow-lg hover:shadow-gray-400 p-5 cursor-pointer hover:scale-105 ease-in duration-100">
            <FaLinkedinIn />
          </div>
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <div className="intersect:motion-preset-expand intersect:motion-delay-200 intersect:motion-duration-200 rounded-full shadow-lg hover:shadow-gray-400 p-5 cursor-pointer hover:scale-105 ease-in duration-100">
            <FaGithub />
          </div>
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <div className="intersect:motion-preset-shrink intersect:motion-delay-300 intersect:motion-duration-300 rounded-full shadow-lg hover:shadow-gray-400 p-5 cursor-pointer hover:scale-105 ease-in duration-100">
            <AiOutlineMail />
          </div>
        </a>

        <a href="https://wa.me/254115483048" target="_blank" rel="noreferrer">
          <div className="intersect:motion-preset-expand motion-delay-400 intersect:motion-duration-400 rounded-full shadow-lg hover:shadow-gray-400 p-5 cursor-pointer hover:scale-105 ease-in duration-100">
            <SiWhatsapp />
          </div>
        </a>
      </div>
